  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" :model="query" class="demo-form-inline" size="mini">
        ...
        <el-form-item>
          <el-button type="primary" @click="fetchUsualList">查询</el-button>
...
<script>
  import {usual_list} from '@/api/log'
  ...
  export default {
    ...
    methods: {
      ...
      currentPageChange(currentPage) {
        this.fetchUsualList({'current': currentPage})
      },
      fetchUsualList(new_query) {
        this.listLoading = true
        new_query = {...new_query, ...this.query}
        usual_list(new_query).then(response => {
